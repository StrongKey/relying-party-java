...
-  The instructions assumes the default ports for all the applications installed and payara runs https on port 8181 by default, so make sure all firewall rules allow that port to be accessed.
